<html>
    <body>
        <div class="container col-12">
            <div class="row">
                <div class="col-6 d-flex justify-content-center align-items-center"><img class="image2 px-4 py-3" src="/UnescoWebsite/images/Vera.png"></div>
            ...
            <div class="row">
                ...
                <div class="col-6 d-flex justify-content-center align-items-center"><img class="image2 px-4 py-3" src="/UnescoWebsite/images/Tatiana.png"></div>
            </div>

            <div class="row">
                <div class="col-6 d-flex justify-content-center align-items-center"><img class="image2 px-4 py-3" src="/UnescoWebsite/images/Rob.png"></div>
                <div class="col-6 center-block fs-5"><br>
            ...
            <div class="row">
                ...
                <div class="col-6 d-flex justify-content-center align-items-center"><img class="image2 px-4 py-3" src="/UnescoWebsite/images/Emily.png"></div>
            </div>
        </div>
    </body>
</html>
